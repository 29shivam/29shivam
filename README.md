...
<a href="https://github.com/ClickHouse/clickhouse-kafka-connect/pull/814">clickhouse-kafka-connect #814</a> — map Avro record unions to a ClickHouse JSON column, verified end-to-end against real ClickHouse, merged by ClickHouse<br/>
<a href="https://github.com/ClickHouse/clickhouse-kafka-connect/pull/802">clickhouse-kafka-connect #802</a> — support the Avro decimal logical type on a fixed base, merged by ClickHouse<br/>
